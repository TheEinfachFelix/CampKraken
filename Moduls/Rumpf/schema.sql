...
CREATE TABLE IF NOT EXISTS "tagToParticipant" (
	"participantId" INTEGER NOT NULL,
	"tagId" INTEGER NOT NULL,
	PRIMARY KEY("participantId", "tagId")
);
...
CREATE TABLE IF NOT EXISTS "tags" (
	"tagId" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"name" TEXT NOT NULL,
	PRIMARY KEY("tagId")
);
...
CREATE TABLE IF NOT EXISTS "nutritionsToPrivate" (
	"nutritionId" INTEGER NOT NULL,
	"participantId" INTEGER NOT NULL,
	PRIMARY KEY("nutritionId", "participantId")
);
...
ADD FOREIGN KEY("personId") REFERENCES "person"("personId")
ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE "nutritionsToPrivate"
ADD FOREIGN KEY("participantId") REFERENCES "participantsPrivate"("participantId")
ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE "nutritionsToPrivate"
