...
namespace BackendTest.Services
{
    internal static class SampleData
    {
        ...
        // Zeitraum: 14.10.2025 – 31.10.2025
        private static List<Day> allDays = Enumerable.Range(0, (new DateOnly(2025, 10, 31).DayNumber - new DateOnly(2025, 10, 14).DayNumber) + 1)
            .Select(offset => new Day { Date = new DateOnly(2025, 10, 14).AddDays(offset) })
            .ToList();
        ...
        public static Person fullPerson = new Person
        {
            ...
            Days = allDays // Person war von 14.–31.10. da
        };
